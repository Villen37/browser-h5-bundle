...
/*import Swiper from "../common/swiper/swiper-4.4.1.min.js";
import "../common/swiper/swiper-4.4.1.min.css";*/
var $ = document.querySelector.bind(document);
//import NewsappAPI from "../common/newsapp-protocol";

var delegate = $(".js-delegate");
var taskTop = $(".js-delegate .task-top");
var isApp = navigator.userAgent.match(/HotNews/i);
...
function getApi() {
    /*fetchSignbox();*/
    fetchTasklist();
    var userInfo = window.extra.getUserInfo();
...
function fetchTasklist() {
    (0, _util.ajax)({
        // url: '/mock/task.json',
        url: "http://browser.xsed.com.cn/api/v1/app/activity/list",
        dataType: "jsonp",
        data: {
            userid: 0,
            type: '123'
...
function recommendList(fn) {
    ...
    NewsappAPI.device(function (info) {
        // 获取用户id
        NewsappAPI.exploreUserinfo(function (_info) {
            var info_u = info.u || '',
                ts = new Date().getTime();
            var devId = info_u,
                passport = _info.name,
            ...
            var promise = new _promise2.default(function (resolve, reject) {
                NewsappAPI.encrypt(devId, function (encryText) {
                    devId = encryText;
            ...
            promise.then(function (resolve) {
                return new _promise2.default(function (resolve, reject) {
                    NewsappAPI.encrypt(passport, function (encryText) {
                        passport = encryText;
            ...
            promise.then(function (resolve) {
                NewsappAPI.encrypt({ info_u: info_u, ts: ts }, function (encryText) {
                    (0, _util.ajax)({
...
function middleware(url, callback) {
    ...
    NewsappAPI.device(function (info) {
        ...
        NewsappAPI.encrypt((0, _extends3.default)({}, data, other), function (encryText) {
            (0, _util.ajax)({
                method: "post",
                url: url,
                data: {
...
function login() {
    window.location.href = "transfer://%7B%22name%22:%22userLogin%22%7D";
}
 ...
 * */
function getAds() {
    if (NewsappAPI.getads && adsShow.yes_ads.length > 0) {
        var type = adsShow.yes_ads.shift();
        NewsappAPI.getads(type, function (adsDate) {
...
function getAllAds(param, fun) {
    if (NewsappAPI.getallads) {
        ...
        NewsappAPI.getallads(type, function (adsDate) {
...
function tongjiAds(id, type, eve, word, fun) {
    if (NewsappAPI.record) {
        ...
        NewsappAPI.record(param, function (tongji) {
            //console.log(tongji)
            fun && fun();
        });
    }
...
//# sourceMappingURL=task-xhh.e1b114bfc3e30b514202.hot-update.js.map